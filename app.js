...
(function () {
  ...
  document.getElementById("a-mgr-p").textContent =
    "Гудилов, Калбаев и Глухов уволены. Никитина переведена в старшие продавцы-консультанты. Цифры ниже — кто выписывал реализации. Книгу Антипино ведёт Александра Яковлева.";
